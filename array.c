...
void print_array_without_length(int p_array[]) {
    ...
    int *p_int = NULL;
    printf("print_array_without_length: sizeof(p_array)=%ld.\n",sizeof(p_array));
    printf("print_array_without_length: sizeof(p_array[0])=%ld.\n",sizeof(p_array[0]));
    printf("print_array_without_length: sizeof(p_int)=%ld.\n",sizeof(p_int));
#if 0
    for(i=0; i < length; i++) {
        printf("Element %d is %d.\n",i, *p_array++);
    }
...
void revise_arrays() {
    ...
    print_array_without_length(array5);
